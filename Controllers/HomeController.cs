...
namespace Shopping_Laptop.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View(products); // Passing List<ProductModel>
        }
        ...
        {
            var compare = await _dataContext.Compare.FindAsync(id);
            if (compare == null)
            {
                TempData["error"] = "Không tìm thấy mục so sánh để xóa.";
        ...
        {
            var wishlist = await _dataContext.Wishlist.FindAsync(id);
            if (wishlist == null)
            {
                TempData["error"] = "Không tìm thấy mục yêu thích để xóa.";
